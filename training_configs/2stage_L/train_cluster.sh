...
#SBATCH --output=logs/training_2stage_L_%j.out
#SBATCH --error=logs/training_2stage_L_%j.err
...
HYPERPARAMS="training_configs/2stage_L/hyperparams.json"
