...
from training.data import PackedDataset, PackedDataCollator, HuggingFaceStreamingDataset
...
def main():
    ...
    from training.data import HuggingFaceStreamingDataset, TextDataset, PackedDataCollator
    ...
    from training.utils import get_lr_scheduler
